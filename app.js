...
=======
   ...
   /* function addWeatherData(element) {
      ...
      function addWeatherIcon(element) {
        document.querySelector("img").src = `http://openweathermap.org/img/w/${element}.png`;
      }
      ...
      var result = fetch(url)
        ...
        .then(function (userIP) {
          ...
          document.getElementById("weather-city").innerHTML = city;
          document.getElementById("weather-country").innerHTML = country;
          return fetch('http://api.openweathermap.org/data/2.5/weather?q=' + city + ',' + region + country + '&appid=ae76d0efed32d9f29c4d54a5738b80ca'); // make a 2nd request and return a promise
        })
        .then(function (response) {
          return response.json();
        })
      ...
      result.then(function (r) {
        ...
        document.getElementById("weather-humidity").innerHTML = humidity + ' %';
        document.getElementById("weather-pressure").innerHTML = pressure + ' hPa';
>>>>>>> e79726d1e5423d2ff0189c746a1bf28675205ead
      });